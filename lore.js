...
const blobPartOne = "Where does the BlobMan start?...*Blob*...That would be earth. The year is 2068. Man has all but destroyed themselves...*Blob*...Before doing so, the world's leaders put their petty differences aside and decided to send a group of spectacular individuals into space. The aim of these individuals...*Blob*...was to find a suitable home for the next wave of humans. They chose people from all backgrounds, focusing on common sense smarts. The journey would be a longer one than they anticipated though...";
...
const blobPartThree = "Once awakened and fully accustomed to the planet's climate, the humans started to spread across the terrain. They deployed the farming...*Blob*...robots they brought with them, that got to immediate work in finding ideal fields and plowing them out. The...*Blob*...humans prospered here far greater than they could have hoped for. Life was easy. Life was in fact so easy...*Blob*...humans began to undergo an evolution. It could be argued it was more devolution than an...*Blob*...evolution though.";
...
const blobPartFour = "The devolution wasn't instantaneous, in total it took...*Blob*...about 33 years. It happened not to the first-generation Innhaus inhabitants, but their children. Due to the lack of work and other predators the...*Blob*...children were all born disfigured. Not third arm or third eye disfigured, but they were all blob shaped. As if the bones didn't form like they once...*Blob*...did. This descendent of the human race was called BlobMen with each one being a...*Blob*...BlobMan. This new generation would change InnHaus forever...";
...
const blobPartFive = "Due...*Blob*...to the blob-like nature, it was hard for this new generation to get around, so they developed a new form of communication...*Blob...they called it BlobSpace. It was a place for all to hang out together, share their ideas, and have some fun. This...*Blob...generation was also a game changer because since they had the time, they rediscovered music. Music was lost on the first inhabitants of the planet InnHaus. They were too focused...*Blob*...on getting their civilization back up and running.";
...
const finalBlob = "Therefore the era of the BlobMan was born. The music-loving, social media using, and blob shaped new age of humans. What's to come for them? Why don't you come find out...";
